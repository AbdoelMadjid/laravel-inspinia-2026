...
@section('content')
    <!-- Top Alert Banner (Disabled / For future info)
            <div class="alert alert-primary top-alert text-center mb-0 rounded-0 alert-dismissible" role="alert">
                ...
                <div class="fst-italic fw-medium">
                    🚀 Inspinia is here! Now with Bootstrap 5, dark mode, and a refreshed UI. Upgrade today for the best experience!
                    ...
                    <div>
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="btn btn-sm btn-primary ms-1">Sign Up</a>
                            @endif
                        @endauth
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <p class="mb-4 fs-sm text-muted lh-lg">
                        Build powerful, modern web applications with our top-rated Admin Dashboard Template. Designed for
                        performance, flexibility, and ease of customization, it’s the perfect solution for startups,
                        agencies, and enterprise teams.
                    </p>

                    <!-- Call to Action Buttons -->
                    <div class="d-flex gap-1 gap-sm-2 flex-wrap justify-content-center">
                        <a class="btn btn-secondary py-2 fw-semibold" href="#"> <i
                                class="ti ti-basket fs-xl me-2"></i>Buy Now! </a>
                        <a class="btn btn-light py-2 fw-semibold"
                            href="https://wrapbootstrap.com/user/WebAppLayers/message" target="_blank"> <i
                                class="ti ti-confetti fs-xl me-2"></i>Contact Us </a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h2 class="mt-3 fw-bold mb-5">Discover Our <mark class="fst-italic">Core Services</mark> and
                        Capabilities</h2>
                </div>
            </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Crafting data-driven strategies to maximize online growth and brand
                                engagement.</p>
                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Improve search engine rankings and increase website visibility
                                through tailored SEO practices.</p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                            <a class="link-primary fw-semibold" href="#">Know more<i
                                    class="ti ti-arrow-right ms-2 align-middle"></i></a>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Engage your audience across platforms with strategic content and
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Building fast, responsive, and scalable websites that meet your
                                business needs.</p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                            <a class="link-primary fw-semibold" href="#">Know more<i
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Connect with your audience and boost conversions through targeted
                                email campaigns.</p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                            <a class="link-primary fw-semibold" href="#">Know more<i
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Launch and manage high-performing online stores with secure,
                                scalable features.</p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                            <a class="link-primary fw-semibold" href="#">Know more<i
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Produce compelling visuals and copy to drive traffic and build brand
                                identity.</p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                            <a class="link-primary fw-semibold" href="#">Know more<i
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Ensure your website and data are secure with comprehensive
        ...
        <div class="container">
            <div class="row align-items-center pb-5">
                ...
                <div class="col-lg-5 ms-auto py-3">
                    ...
                    <p class="mb-2 lead">Fast, secure, and intuitive—our chat platform empowers teams and communities to
                        communicate effortlessly, no matter the distance.</p>
                    <p class="text-muted fs-sm mb-4">Experience seamless messaging with built-in privacy features and
                        unmatched reliability.</p>
                    <a href="{{ route('page', 'chat') }}" class="btn btn-primary mb-4">Check Chat App</a>
            ...
            <div class="row align-items-center py-5">
                <div class="col-lg-5 py-5 order-2 order-lg-1">
                    ...
                    <p class="mb-2 lead">A powerful, secure, and intuitive file manager built to simplify how individuals
                        and teams store, share, and organize files.</p>
                    <p class="text-muted fs-sm mb-4">Access files instantly, collaborate in real-time, and enjoy peace of
                        mind with encrypted storage.</p>
                    <a href="{{ route('page', 'file-manager') }}" class="btn btn-primary mb-4">Explore File Manager</a>
                ...
                <div class="col-lg-6 col-xl-5 ms-auto py-5 order-1 order-lg-2">
                    <div class="position-relative">
                        ...
                        <!-- Main image -->
                        <img src="{{ asset('assets/images/file-manager.png') }}"
                            class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" alt="saas-img" />
            ...
            <div class="row align-items-center py-5">
                ...
                <div class="col-lg-5 ms-auto py-3">
                    ...
                    <p class="mb-2 lead">Our smart contacts app keeps all your relationships organized, accessible, and in
                        sync across devices—at home or on the go.</p>
                    <p class="text-muted fs-sm mb-4">Effortlessly import, categorize, and interact with contacts through a
                        clean, privacy-focused interface.</p>
                    <a href="{{ route('page', 'contacts') }}" class="btn btn-primary mb-4">Check Contacts App</a>
                    ...
                    <div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
                        ...
                        <div>
                            <h3 class="mb-2"><span data-target="250000">0</span><span class="text-primary">+</span>
                            </h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h2 class="mt-3 fw-bold mb-5">Choose the <mark class="fst-italic">License</mark> That Fits Your Needs
                    </h2>
                </div>
            </div>
            <!-- end row-->
                            ...
                            <div class="card h-100 bg-light bg-opacity-10 border-light rounded-3">
                                <div class="card-body px-lg-4 p-5 pb-2 text-center">
                                    ...
                                    <ul class="list-unstyled text-start fs-sm fw-medium mb-0">
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> 1 project
                                            usage</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Full
                                            component access</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Basic
                                            documentation</li>
                                        <li class="mb-2"><i class="ti ti-x text-danger me-2 fs-5"></i> No multi-client
                                            use</li>
                                        <li class="mb-2"><i class="ti ti-x text-danger me-2 fs-5"></i> No SaaS/resale
                                            rights</li>
                                    </ul>
                                </div>
                                <div class="card-footer bg-transparent border-0 px-5 pb-4">
                                    <a href="#!"
                                        class="btn btn-outline-primary w-100 py-2 fw-semibold rounded-pill">Buy Single
                                        License</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 bg-light bg-opacity-10 border-dashed border my-4 my-lg-0 rounded-3">
                                <div class="card-body px-lg-4 p-5 pb-2 text-center">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">For developers or agencies working with multiple clients
                                        </p>
                                    </div>
                                    <div class="my-4">
                                    ...
                                    <ul class="list-unstyled text-start fs-sm fw-medium mb-0">
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Use in up to
                                            5 projects</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Commercial
                                            client use</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Lifetime
                                            updates</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Premium
                                            support</li>
                                        <li class="mb-2"><i class="ti ti-x text-danger me-2 fs-5"></i> No resale/SaaS
                                            rights</li>
                                    </ul>
                                </div>
                                <div class="card-footer bg-transparent border-0 px-5 pb-4">
                                    <a href="#!" class="btn btn-primary w-100 py-2 fw-semibold rounded-pill">Buy
                                        Multiple License</a>
                                </div>
                                <span
                            ...
                            <div class="card h-100 bg-light bg-opacity-10 border-light rounded-3">
                                <div class="card-body px-lg-4 p-5 pb-2 text-center">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">For SaaS products or items offered in paid applications
                                        </p>
                                    </div>
                                    <div class="my-4">
                                        <h1 class="display-6 fw-bold mb-0">$999</h1>
                                        <small class="d-block text-muted fs-base fw-medium">One-time payment</small>
                                        <small class="d-block text-muted fw-medium">Commercial redistribution
                                            rights</small>
                                    </div>

                                    <ul class="list-unstyled text-start fs-sm fw-medium mb-0">
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Unlimited
                                            project usage</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> SaaS &
                                            resale rights</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Full Figma
                                            source files</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Priority
                                            support</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Custom
                                            licensing agreement</li>
                                    </ul>
                                </div>
                                <div class="card-footer bg-transparent border-0 px-5 pb-4">
                                    <a href="#!" class="btn btn-dark w-100 py-2 fw-semibold rounded-pill">Buy
                                        Extended License</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container position-relative">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h2 class="mt-3 fw-bold mb-5">Real Feedback from <mark class="fst-italic">Satisfied</mark> Clients
                    </h2>
                </div>
            </div>
            <!-- end row-->
                ...
                <div class="col-lg-4">
                    <div class="card border-light rounded-4 p-3 card-h-100">
                        <div class="card-body pb-0 text-center">
                            ...
                            <p class="text-muted mb-3 fst-italic fs-sm">"This gadget exceeded all my expectations. Sleek
                                design and incredible performance!"</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card border-light rounded-4 p-3 card-h-100">
                        <div class="card-body pb-0 text-center">
                            ...
                            <p class="text-muted mb-3 fst-italic fs-sm">"Sturdy build and long battery life. Would
                                definitely recommend it to friends!"</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card border-light rounded-4 p-3 card-h-100">
                        <div class="card-body pb-0 text-center">
                            ...
                            <p class="text-muted mb-3 fst-italic fs-sm">"The team helped me with my issue right away.
                                Smooth experience overall!"</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card border-light rounded-4 p-3 card-h-100">
                        <div class="card-body pb-0 text-center">
                            ...
                            <p class="text-muted mb-3 fst-italic fs-sm">"The performance and features are unmatched in this
                                price range. Highly impressed!"</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card border-light rounded-4 p-3 card-h-100">
                        <div class="card-body pb-0 text-center">
                            ...
                            <p class="text-muted mb-3 fst-italic fs-sm">"The website, shipping, and support all worked
                                flawlessly. Very satisfied!"</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h2 class="mt-3 fw-bold mb-5">Explore Our <mark class="fst-italic">Latest</mark> Articles and Updates
                    </h2>
                </div>
            </div>
            <!-- end row-->
                    ...
                    <article class="card rounded-3 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-lg lh-base mb-2">
                                <a href="{{ route('page', 'article') }}" class="link-reset">The Future of Artificial
                                    Intelligence</a>
                            </h6>
                            <p class="mb-3 text-muted">Discover how AI is transforming industries and what the future holds
                                for this cutting-edge technology.</p>
                        ...
                        <div class="card-footer bg-transparent d-flex justify-content-between border-0">
                            ...
                            <a class="link-primary fw-semibold" href="{{ route('page', 'article') }}">Read more <i
                ...
                <div class="col-lg-4">
                    <article class="card rounded-3 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h6 class="card-title fs-lg lh-base mb-2">
                                <a href="{{ route('page', 'article') }}" class="link-reset">Top Data Science Trends in
                                    2025</a>
                            </h6>
                ...
                <div class="col-lg-4">
                    <article class="card rounded-3 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h6 class="card-title fs-lg lh-base mb-2">
                                <a href="{{ route('page', 'article') }}" class="link-reset">5 Key Tips for New
                                    Entrepreneurs</a>
                            </h6>
                            <p class="mb-3 text-muted">Start your entrepreneurial journey with these 5 essential tips that
                                will guide you through the first year of business.</p>
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <div>
                                ...
                                <h5 class="my-1 lh-lg">INSPINIA HQ, 123 Market Street, 5th Floor, Financial District, San
                                    Francisco, CA 94103, United States</h5>
                            </div>
                        </div>
                    </div>
                    <!-- end .p-4-->
                    ...
                    <form class="p-4 border rounded-4 border-dashed">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control py-2" id="name" autocomplete="name"
                                    placeholder="Enter your full name" />
                            </div>

                            <div class="col-md-6">
                                <label for="email" class="form-label">Email Address</label>
                                <input type="email" class="form-control py-2" id="email" autocomplete="email"
                    ...
                    <div class="col-4" id="width-fluid">
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 w-100" for="layout-width-fluid">
                                <img src="{{ asset('assets/images/layouts/width-fluid.png') }}" alt="layout-img"
                                    class="img-fluid" />
                            </label>
                        </div>
                    ...
                    <div class="col-4" id="width-boxed">
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 w-100" for="layout-width-boxed">
                                <img src="{{ asset('assets/images/layouts/width-boxed.png') }}" alt="layout-img"
                                    class="img-fluid" />
                            </label>
                        </div>
    ...
    <!-- Back to Top Button -->
    <button type="button" id="btn-back-to-top" class="btn btn-primary rounded-circle shadow-lg"
