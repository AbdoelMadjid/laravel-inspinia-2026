...
<!-- Top Alert Banner (Disabled / For future info)
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        ...
                        <div class="avatar-group avatar-group-sm justify-content-center mt-2">
                            <div class="avatar">
                                <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="Ava Lee" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="avatar">
                                <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="Ethan King" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="avatar">
                                <img src="{{ asset('assets/images/users/user-9.jpg') }}" alt="Lucas White" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="avatar">
                                <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="Lucas White" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="avatar">
                                <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="Lucas White" class="avatar-sm rounded-circle" />
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-1 gap-sm-2 flex-wrap justify-content-center">
                            <a class="btn btn-secondary py-2 fw-semibold" href="#"> <i class="ti ti-basket fs-xl me-2"></i>Buy Now! </a>
                            <a class="btn btn-light py-2 fw-semibold" href="https://wrapbootstrap.com/user/WebAppLayers/message" target="_blank"> <i class="ti ti-confetti fs-xl me-2"></i>Contact Us </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container position-relative">
                    ...
                    <div class="row">
                        <div class="col-md-10 mx-auto position-relative">
                            ...
                            <!-- Hero Main Image -->
                            <img src="{{ asset('assets/images/dashboard-1.png') }}" class="rounded-top-4 shadow-lg img-fluid mt-5" alt="saas-img" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center pb-5">
                    <div class="col-lg-6 col-xl-5 py-3">
                        <div class="position-relative">
                            ...
                            <!-- Main image -->
                            <img src="{{ asset('assets/images/chat.png') }}" class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" alt="saas-img" />
                ...
                <div class="row align-items-center py-5">
                    ...
                    <div class="col-lg-6 col-xl-5 ms-auto py-5 order-1 order-lg-2">
                        <div class="position-relative">
                            ...
                            <!-- Main image -->
                            <img src="{{ asset('assets/images/file-manager.png') }}" class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" alt="saas-img" />
                ...
                <div class="row align-items-center py-5">
                    <div class="col-lg-6 col-xl-5 py-3">
                        <div class="position-relative">
                            ...
                            <!-- Main image -->
                            <img src="{{ asset('assets/images/team.png') }}" class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" alt="saas-img" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card h-100 bg-light bg-opacity-10 border-dashed border my-4 my-lg-0 rounded-3">
                                    ...
                                    <span class="position-absolute top-0 start-50 translate-middle-x badge bg-primary-subtle text-primary rounded-pill px-3 py-1 mt-3"> Best Value </span>
                                </div>
                            </div>
    ...
    ======================= -->
        ...
        <section>
            <div class="section-cta position-relative card-side-img overflow-hidden" style="background-image: url({{ asset('assets/images/landing-cta.jpg') }})">
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="card border-light rounded-4 p-3 card-h-100">
                            <div class="card-body pb-0 text-center">
                                <div class="avatar avatar-xl mx-auto mb-3">
                                    <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="Emily Carter" class="img-fluid rounded-circle" />
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-light rounded-4 p-3 card-h-100">
                            <div class="card-body pb-0 text-center">
                                <div class="avatar avatar-xl mx-auto mb-3">
                                    <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="Michael Zhang" class="img-fluid rounded-circle" />
                                </div>
                                <span class="text-warning fs-lg mb-3 d-block">
                                    <span class="ti ti-star-filled"></span>
                                    <span class="ti ti-star-filled"></span>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-light rounded-4 p-3 card-h-100">
                            <div class="card-body pb-0 text-center">
                                <div class="avatar avatar-xl mx-auto mb-3">
                                    <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="Sara Lopez" class="img-fluid rounded-circle" />
                                </div>
                                <span class="text-warning fs-lg mb-3 d-block">
                                    <span class="ti ti-star-filled"></span>
                                    <span class="ti ti-star-filled"></span>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-light rounded-4 p-3 card-h-100">
                            <div class="card-body pb-0 text-center">
                                <div class="avatar avatar-xl mx-auto mb-3">
                                    <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="James Whitman" class="img-fluid rounded-circle" />
                                </div>
                                <span class="text-warning fs-lg mb-3 d-block">
                                    <span class="ti ti-star-filled"></span>
                                    <span class="ti ti-star-filled"></span>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-light rounded-4 p-3 card-h-100">
                            <div class="card-body pb-0 text-center">
                                <div class="avatar avatar-xl mx-auto mb-3">
                                    <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="Aisha Khan" class="img-fluid rounded-circle" />
                                </div>
                                <span class="text-warning fs-lg mb-3 d-block">
                                    <span class="ti ti-star-filled"></span>
                                    <span class="ti ti-star-filled"></span>
                        ...
                        <article class="card rounded-3 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="card-title fs-lg lh-base mb-2">
                                    <a href="{{ route('page', 'article') }}" class="link-reset">The Future of Artificial Intelligence</a>
                                </h6>
                            ...
                            <div class="card-footer bg-transparent d-flex justify-content-between border-0">
                                ...
                                <a class="link-primary fw-semibold" href="{{ route('page', 'article') }}">Read more <i class="ti ti-arrow-right"></i></a>
                            </div>
                        </article>
                    </div>
                    <!-- end col-->
                    ...
                    <div class="col-lg-4">
                        <article class="card rounded-3 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <!-- Title -->
                                <h6 class="card-title fs-lg lh-base mb-2">
                                    <a href="{{ route('page', 'article') }}" class="link-reset">Top Data Science Trends in 2025</a>
                                </h6>
                    ...
                    <div class="col-lg-4">
                        <article class="card rounded-3 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <!-- Title -->
                                <h6 class="card-title fs-lg lh-base mb-2">
                                    <a href="{{ route('page', 'article') }}" class="link-reset">5 Key Tips for New Entrepreneurs</a>
                                </h6>
    ...
    ======================= -->
        <footer class="section-custom section-footer pb-2">
            <div class="container">
                ...
                <div class="row mt-5">
                    <div class="col-12 text-center">
                        <p class="mb-4">© 2014 - <span data-current-year></span> Inspinia By <span class="fw-semibold">WebAppLayers</span></p>
                    </div>
                </div>
                <!-- end row-->
            </div>
    ...
    ======================= -->
        ...
        <!-- Back to Top Button -->
        <button type="button" id="btn-back-to-top" class="btn btn-primary rounded-circle shadow-lg" aria-label="Back to top">
