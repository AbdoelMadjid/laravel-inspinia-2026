...
@section('title', 'Projects Dashboard | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="progress progress-sm mb-1">
                                            <div class="progress-bar bg-secondary" role="progressbar" style="width: 54.2%" aria-valuenow="54.20" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline timeline-icon-bordered">
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="Natalie Brooks" class="rounded-circle avatar-xxs" />
                                                    <a href="{{ route('page', 'pages-profile') }}" class="fw-medium link-reset text-muted">Natalie Brooks</a>
                                                </div>
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="Oliver Grant" class="rounded-circle avatar-xxs" />
                                                    <a href="{{ route('page', 'pages-profile') }}" class="fw-medium link-reset text-muted">Oliver Grant</a>
                                                </div>
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('assets/images/users/user-9.jpg') }}" alt="Clara Jensen" class="rounded-circle avatar-xxs" />
                                                    <a href="{{ route('page', 'pages-profile') }}" class="fw-medium link-reset text-muted">Clara Jensen</a>
                                                </div>
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('assets/images/users/user-10.jpg') }}" alt="Leo Armstrong" class="rounded-circle avatar-xxs" />
                                                    <a href="{{ route('page', 'pages-profile') }}" class="fw-medium link-reset text-muted">Leo Armstrong</a>
                                                </div>
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="Liam Carter" class="rounded-circle avatar-xxs" />
                                                    <a href="{{ route('page', 'pages-profile') }}" class="fw-medium link-reset text-muted">Liam Carter</a>
                                                </div>
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="Emma Davis" class="rounded-circle avatar-xxs" />
                                                    <a href="{{ route('page', 'pages-profile') }}" class="fw-medium link-reset text-muted">Emma Davis</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body bg-light-subtle border-bottom border-dashed">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="fs-xs mb-0 text-body-secondary">You have <span class="text-body fw-semibold">22</span> new messages and <span class="text-body fw-semibold">16</span> waiting in draft folder.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card-body-->
                                ...
                                <div class="card-body pt-1">
                                    <ul class="list-group list-group-flush mb-3">
                                        ...
                                        <li class="list-group-item px-0 border-light">
                                            <div class="d-flex gap-2">
                                                <div class="me-2 flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/user-8.jpg') }}" class="avatar-md rounded-circle" alt="user-8" />
                                                </div>
                                                <div class="flex-grow-1 text-muted">
                                                    ...
                                                    <a href="{{ route('page', 'chat') }}" class="badge badge-soft-primary p-1">Reply</a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item px-0 border-light">
                                            <div class="d-flex gap-2">
                                                <div class="me-2 flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/user-10.jpg') }}" class="avatar-md rounded-circle" alt="user-10" />
                                                </div>
                                                <div class="flex-grow-1 text-muted">
                                                    <h6 class="text-body mb-1 fs-base d-flex justify-content-between">
                                                        Michael Brown
                                        ...
                                        <li class="list-group-item px-0 border-light">
                                            <div class="d-flex gap-2">
                                                <div class="me-2 flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/user-1.jpg') }}" class="avatar-md rounded-circle" alt="user-1" />
                                                </div>
                                                <div class="flex-grow-1 text-muted">
                                                    <h6 class="text-body mb-1 fs-base d-flex justify-content-between">
                                                        Emily Watson
                                        ...
                                        <li class="list-group-item px-0 border-light">
                                            <div class="d-flex gap-2">
                                                <div class="me-2 flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/user-6.jpg') }}" class="avatar-md rounded-circle" alt="user-6" />
                                                </div>
                                                <div class="flex-grow-1 text-muted">
                                                    <h6 class="text-body mb-1 fs-base d-flex justify-content-between">
                                                        Monica Smith
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="{{ route('page', 'chat') }}" class="link-reset text-decoration-underline fw-semibold link-offset-3"> Go to Chat Room <i class="ti ti-send-2"></i> </a>
                                    </div>
                                </div>
                                <!-- end card-body-->
                            </div>
