...
@section('title', 'Dashboard | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                            ...
                            <div class="col-xxl-3 col-xl-6 order-xl-1 order-xxl-0">
                                <div class="p-4 border-end border-dashed">
                                    ...
                                    <span class="text-muted">You have <span class="text-primary fw-semibold">42</span>
                                        messages and 6 notifications.</span>
                                    ...
                                    <div class="row text-center mb-3">
                                        <div class="col">
                                            <div class="bg-light bg-opacity-50 p-2">
                                                <h5 class="m-0"><span class="text-muted">Total Revenue:</span>$ <span
                                                        data-target="40">0</span>M</h5>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="bg-light bg-opacity-50 p-2">
                                                <h5 class="m-0"><span class="text-muted">Total Orders:</span> <span
                                                        data-target="50.9">0</span>k</h5>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="timeline-content ps-3">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="mb-1 fs-base">New Feature Released <span
                                                class="badge badge-label badge-soft-info ms-2">Deploy</span></h5>
                                        <span class="text-muted fs-xxs">Today at 3:45 PM</span>
                                    </div>
                                    <p class="mb-1 text-muted">Launched the real-time chat feature across all user
                                        accounts.</p>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="Natalie Brooks"
                                            class="rounded-circle avatar-xxs" />
                                        <a href="{{ route('page', 'pages-profile') }}"
                                ...
                                <div class="timeline-content ps-3">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="mb-1 fs-base">Team Sync-Up <span
                                                class="badge badge-label badge-soft-secondary ms-2">Meeting</span></h5>
                                        <span class="text-muted fs-xxs">Today at 2:00 PM</span>
                                    </div>
                                    <p class="mb-1 text-muted">Reviewed sprint progress and discussed remaining tasks with
                                        the dev team.</p>
                                    <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="timeline-content ps-3">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="mb-1 fs-base">UI Design Review <span
                                                class="badge badge-label badge-soft-success ms-2">Design</span></h5>
                                        <span class="text-muted fs-xxs">Today at 1:15 PM</span>
                                    </div>
                                    <p class="mb-1 text-muted">Updated component spacing and colors for improved
                                        accessibility.</p>
                                    <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="timeline-content ps-3">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="mb-1 fs-base">Database Optimization <span
                                                class="badge badge-label badge-soft-danger ms-2">Backend</span></h5>
                                        <span class="text-muted fs-xxs">Today at 12:30 PM</span>
                                    </div>
                                    <p class="mb-1 text-muted">Improved DB query performance, reducing load time by 35%.
                                    </p>
                                    <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="timeline-content ps-3">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="mb-1 fs-base">Security Audit Completed <span
                                                class="badge badge-label badge-soft-warning ms-2">Audit</span></h5>
                                        <span class="text-muted fs-xxs">Today at 11:00 AM</span>
                                    </div>
                                    <p class="mb-1 text-muted">Completed internal security audit with no critical issues
                                        found.</p>
                                    <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="timeline-content ps-3">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="mb-1 fs-base">New Team Member Joined <span
                                                class="badge badge-label badge-soft-primary ms-2">Onboarding</span></h5>
                                        <span class="text-muted fs-xxs">Today at 10:15 AM</span>
                                    </div>
                                    <p class="mb-1 text-muted">Michael Lee has joined the development team as a Frontend
                                        Engineer.</p>
                                    <div class="d-flex align-items-center gap-2">
                ...
                <div class="card">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="fs-xs mb-0 text-body-secondary">You have <span
                                        ...
                                        class="text-body fw-semibold">16</span> waiting in draft folder.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end card-body-->
                    ...
                    <div class="card-body pt-1">
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('page', 'chat') }}"
                                class="link-reset text-decoration-underline fw-semibold link-offset-3"> Go to Chat Room <i
                                    class="ti ti-send-2"></i> </a>
                        </div>
                    </div>
                    <!-- end card-body-->
                </div>
