...
@section('html_class', 'sidebar-no-icons sidebar-with-line')

@section('title', 'Sidebar without Icons with Lines | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
