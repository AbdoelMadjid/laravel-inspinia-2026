...
@section('title', 'Echart Scatter Chart | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/chart-echart-scatter.js') }}"></script>
@endpush
