...
@section('title', 'Blog Article | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                ...
                                <div class="card-body p-lg-5">
                                    <div class="row g-5">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <!-- Image -->
                                            <img src="{{ asset('assets/images/blog/blog-post.jpg') }}" class="img-fluid rounded mt-4" alt="blog-img" />
                                            ...
                                            <div class="d-flex align-items-center gap-4 border mt-4 border-dashed p-4 rounded mb-14">
                                                <div class="text-center flex-shrink-0 me-7 me-lg-13">
                                                    <div class="mb-2">
                                                        <img src="{{ asset('assets/images/users/user-1.jpg') }}" class="avatar-xl rounded-circle" alt="" />
                                                    </div>
                                                    <div class="mb-0">
