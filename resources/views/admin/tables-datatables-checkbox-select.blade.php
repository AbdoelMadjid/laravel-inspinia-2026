...
@section('title', 'Checkbox Select Datatables | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@push('styles')
    <link href="{{ asset('assets/plugins/datatables/select.bootstrap5.min.css') }}" rel="stylesheet" type="text/css" />
...
@push('scripts')
    ...
    <script src="{{ asset('assets/plugins/datatables/select.bootstrap5.min.js') }}"></script>
    <script src="{{ asset('assets/js/pages/datatables-checkbox-select.js') }}"></script>
@endpush
