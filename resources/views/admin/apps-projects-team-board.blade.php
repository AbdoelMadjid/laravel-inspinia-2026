...
@section('title', 'Team Board | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@section('content')
<div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Team Board</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Team Board</li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="d-flex gap-2 mb-3 mb-xl-0">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title text-bg-light rounded-circle">
                                                                <i class="ti ti-layout-kanban fs-lg text-primary"></i>
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="d-flex gap-2">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title text-bg-light rounded-circle">
                                                                <i class="ti ti-medal fs-lg text-primary"></i>
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="my-3">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <p class="mb-0 text-muted fw-semibold fs-xs">Status of current project</p>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card card-h-100">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="avatar-group avatar-group-sm mb-3">
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                                </div>
                                                <div class="avatar">
                                                ...
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card card-h-100">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="d-flex gap-2 mb-3 mb-xl-0">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title text-bg-light rounded-circle">
                                                                <i class="ti ti-list-details fs-lg text-primary"></i>
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="d-flex gap-2">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title text-bg-light rounded-circle">
                                                                <i class="ti ti-user-hexagon fs-lg text-primary"></i>
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="my-3">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <p class="mb-0 text-muted fw-semibold fs-xs">Status of current ops</p>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card card-h-100">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="d-flex gap-2 mb-3 mb-xl-0">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title text-bg-light rounded-circle">
                                                                <i class="ti ti-report fs-lg text-primary"></i>
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="my-3">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <p class="mb-0 text-muted fw-semibold fs-xs">Q2 Audit Progress</p>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card card-h-100">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="d-flex gap-2">
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title text-bg-light rounded-circle">
                                                                <i class="ti ti-chart-donut fs-lg text-primary"></i>
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="my-3">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <p class="mb-0 text-muted fw-semibold fs-xs">Campaign Completion</p>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card card-h-100">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="my-3">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <p class="mb-0 text-muted fw-semibold fs-xs">Current Load</p>
