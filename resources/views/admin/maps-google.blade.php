...
@section('title', 'Google Maps | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-8">
                                                <iframe
                                                    ...
                                                    style="width: 100%; height: 360px; overflow: hidden; border: 0; filter: invert(100%) hue-rotate(180deg)"
                                                ></iframe>
                                            </div>
                                        </div>
                                    </div>
