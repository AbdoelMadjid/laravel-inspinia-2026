...
@section('title', 'Contacts | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Sophia Carter</a>
                                                <img src="{{ asset('assets/images/flags/gb.svg') }}" alt="UK" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="{{ route('page', 'apps-users-profile') }}" class="btn btn-soft-primary btn-sm rounded-pill">View Profile</a>
                                    </div>
                                </div>
                                <!-- end card-body-->
                            </div>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Marcus Lee</a>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Emily Davis</a>
                                                <img src="{{ asset('assets/images/flags/us.svg') }}" alt="US" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Daniel Smith</a>
                                                <img src="{{ asset('assets/images/flags/ca.svg') }}" alt="US" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Daniel Morris</a>
                                                <img src="{{ asset('assets/images/flags/us.svg') }}" alt="USA" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                                    ...
                                    <ul class="list-unstyled text-muted mb-4">
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">daniel@projecthub.io</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="{{ route('page', 'apps-users-profile') }}" class="btn btn-soft-success btn-sm rounded-pill">View Profile</a>
                                    </div>
                                </div>
                                <!-- end card-body-->
                            </div>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Jessica Chen</a>
                                                <img src="{{ asset('assets/images/flags/cn.svg') }}" alt="CN" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                                    ...
                                    <ul class="list-unstyled text-muted mb-4">
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">jessica@uxstudio.cn</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+86 10-1234-5678</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                                    ...
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <div class="avatar rounded-circle flex-shrink-0" style="height: 72px; width: 72px">
                                                <span class="avatar-title text-bg-primary fw-semibold rounded-circle fs-22">AP</span>
                                            </div>
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Arjun Patel</a>
                                                <img src="{{ asset('assets/images/flags/in.svg') }}" alt="IN" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                                    ...
                                    <ul class="list-unstyled text-muted mb-4">
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">arjun@techflow.in</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+91 98765-43210</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Olivia Garcia</a>
                                                <img src="{{ asset('assets/images/flags/es.svg') }}" alt="ES" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                                    ...
                                    <ul class="list-unstyled text-muted mb-4">
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">olivia@contentwave.es</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+34 912 345 678</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
