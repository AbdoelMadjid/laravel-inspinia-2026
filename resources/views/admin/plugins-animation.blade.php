...
@section('title', 'Animation | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                                ...
                                                <div class="card card-top-sticky overflow-hidden">
                                                    <div class="card-body">
                                                        <div id="animation_box" class="animate__animated">
                                                            <img src="{{ asset('assets/images/blog/blog-1.jpg') }}" class="img-fluid rounded" alt="user" />
                                                        </div>
