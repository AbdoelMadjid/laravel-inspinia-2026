...
@section('title', 'Editors | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('styles')
    ...
    <link href="{{ asset('assets/plugins/quill/quill.bubble.css') }}" rel="stylesheet" type="text/css" />
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="summernote">
                                            ...
                                            MyAdmin Admin is a powerful and feature-rich Bootstrap-based admin template designed to help you build stunning and functional dashboards. It provides a clean, responsive, and easy-to-use interface for managing data and providing
                                            insights. With numerous components and options, it is perfect for building any type of web application.
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/form-quilljs.js') }}"></script>
@endpush
