...
@section('title', 'Checkout | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                        ...
                        <div class="row">
                                                ...
                                                <div class="tab-pane fade" id="courseInfo">
                                                    ...
                                                    <div class="border p-3 mb-3 rounded">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                                <img src="{{ asset('assets/images/cards/paypal.svg') }}" height="32" alt="paypal-img" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="border p-3 mb-3 rounded">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                                <img src="{{ asset('assets/images/cards/mastercard.svg') }}" height="32" alt="master-card-img" />
                                                                <img src="{{ asset('assets/images/cards/discover-card.svg') }}" height="32" alt="discover-card-img" />
                                                                <img src="{{ asset('assets/images/cards/visa.svg') }}" height="32" alt="visa-card-img" />
                                                                <img src="{{ asset('assets/images/cards/stripe.svg') }}" height="32" alt="stripe-card-img" />
                                                            </div>
                                                        </div>
                                                        <!-- end row -->
                                                        <div class="row mt-4">
                                                    ...
                                                    <div class="border p-3 mb-3 rounded">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                                <img src="{{ asset('assets/images/cards/payoneer.svg') }}" height="32" alt="payoneer" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="border p-3 mb-3 rounded">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                                <img src="{{ asset('assets/images/cards/cod.png') }}" height="24" alt="COD-img" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade" id="parentInfo">
                                                    <div class="p-4">
                                                        ...
                                                        <div class="mt-4">
                                                            ...
                                                            <a href="{{ route('page', 'apps-ecommerce-products-grid') }}" class="btn btn-link fw-semibold text-muted"><i class="ti ti-arrow-left me-1"></i> Continue Shopping</a>
                                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center gap-3 mb-3">
                                            <img src="{{ asset('assets/images/products/2.png') }}" class="me-1 rounded" width="42" alt="MacBook Air" />
                                            <div>
                                                <p class="mb-1 fw-semibold">
                                                    <a href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Apple MacBook Air M3 13”</a>
                                                </p>
                                        ...
                                        <div class="d-flex align-items-center gap-3 mb-3">
                                            <img src="{{ asset('assets/images/products/5.png') }}" class="me-1 rounded" width="42" alt="Sony Headphones" />
                                            <div>
                                                <p class="mb-1 fw-semibold">
                                                    <a href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Sony WH-1000XM5 Wireless Headphones</a>
                                                </p>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/products/7.png') }}" class="me-1 rounded" width="42" alt="Apple Watch" />
                                            <div>
                                                <p class="mb-1 fw-semibold">
                                                    <a href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Apple Watch Series 9 GPS</a>
                                                </p>
