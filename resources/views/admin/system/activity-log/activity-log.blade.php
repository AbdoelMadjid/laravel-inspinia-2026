        ...
        <div class="page-title-head d-flex align-items-center">
            ...
            <div class="text-end">
                <ol class="breadcrumb m-0 py-0">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);" data-lang="apps-management">Apps
                            Management</a></li>
                ...
                <form method="GET" action="{{ route('admin.activity-logs.index') }}" class="row g-2">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="search" class="form-control"
                            placeholder="Cari aksi, deskripsi, IP, nama user..." value="{{ request('search') }}">
                    </div>
                            ...
                            @forelse($logs as $log)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge bg-secondary-subtle text-secondary border">Sistem
                                                Otomatis</span>
                                        @endif
                                    </td>
                                    <td>
                                        @php
                                            $badgeClass = match (true) {
                                                ...
                                                str_contains($log->action, 'APPROVE')
                                                    => 'bg-success-subtle text-success border-success-subtle',
                                                str_contains($log->action, 'IMPORT') ||
                                                    str_contains($log->action, 'EXPORT')
