...
@section('title', 'Project Overview | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                        ...
                                        <div class="card-header align-items-start p-4">
                                            <div class="avatar-xxl me-3">
                                                <span class="avatar-title text-bg-light rounded">
                                                    <img src="{{ asset('assets/images/logos/starbucks.svg') }}" height="48" alt="Brand-img" />
                                                </span>
                                            </div>
                                            <div>
                                        ...
                                        <div class="card-body px-4">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade active show" id="comments" role="tabpanel">
                                                    ...
                                                    <div class="d-flex mb-2 border border-dashed rounded p-3">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="" class="avatar-sm rounded-circle shadow-sm" />
                                                        </div>
                                                        <div class="flex-grow-1 ms-2">
                                                            <h5 class="mb-1">
                                                                Daniel West
                                                ...
                                                <div class="tab-pane fade" id="activity" role="tabpanel">
                                                    <div class="d-flex gap-1 border-bottom border-dashed pb-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('assets/images/users/user-1.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
                                                    ...
                                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
                                                        <div class="flex-grow-1 text-muted">
                                                    ...
                                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
                                                        <div class="flex-grow-1 text-muted">
                                                    ...
                                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
                                                        <div class="flex-grow-1 text-muted">
                                                    ...
                                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('assets/images/users/user-5.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
