...
@section('title', 'Forms Layout | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                    ...
                                    <div class="card-body">
                                        <div class="row g-4 align-items-center">
                                            ...
                                            <div class="col-sm-6 text-center">
                                                ...
                                                <a href="{{ route('page', 'auth-sign-up') }}" class="link-primary text-decoration-underline fw-semibold link-offset-3">Create Your Account</a>
                                            </div>
                                        </div>
                                        <!-- end row-->
                                    </div>
