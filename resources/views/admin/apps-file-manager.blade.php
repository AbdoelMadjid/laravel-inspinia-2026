...
@section('title', 'File Manager | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
<div class="container-fluid">
                    ...
                    <div class="outlook-box">
                            ...
                            <div class="card h-100 mb-0 rounded-end-0" data-simplebar>
                                <div class="card-body">
                                    ...
                                    <div class="list-group list-group-flush list-custom mt-3">
                                        <a href="{{ route('page', 'file-manager') }}" class="list-group-item list-group-item-action active">
                        ...
                        <div data-table data-table-rows-per-page="8" class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a href="{{ asset('assets/images/users/user-1.jpg') }}" download class="dropdown-item">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                                        <h5 class="mb-0 fs-base">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        ...
                                                        <div class="dropdown flex-shrink-0 text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a href="{{ asset('assets/images/users/user-4.jpg') }}" download class="dropdown-item">
                                                                    <i class="ti ti-download me-1"></i>
                                                                    Download
                                                                </a>
                                                                <a href="javascript:void(0);" class="dropdown-item">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                                        <h5 class="mb-0 fs-base">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                                        <h5 class="mb-0 fs-base">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        ...
                                                        <div class="dropdown flex-shrink-0 text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a href="{{ asset('assets/files/proposal.pdf') }}" download class="dropdown-item">
                                                                    <i class="ti ti-download me-1"></i>
                                                                    Download
                                                                </a>
                                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        ...
                                                        <div class="dropdown flex-shrink-0 text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a href="{{ asset('assets/files/dependency.dep') }}" download class="dropdown-item">
                                                                    <i class="ti ti-download me-1"></i>
                                                                    Download
                                                                </a>
                                                                <a href="javascript:void(0);" class="dropdown-item">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                                        <h5 class="mb-0 fs-base">
                                                ...
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        ...
                                                        <div class="avatar">
                                                            <img src="{{ asset('assets/images/users/user-10.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        ...
                                                        <div class="dropdown flex-shrink-0 text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a href="{{ asset('assets/images/users/user-6.jpg') }}" download class="dropdown-item">
                                                                    <i class="ti ti-download me-1"></i>
                                                                    Download
                                                                </a>
                                                                <a href="javascript:void(0);" class="dropdown-item">
