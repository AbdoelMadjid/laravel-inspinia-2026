...
@section('title', 'Categories | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center gap-1">
                                        ...
                                        <a href="#!" class="btn btn-primary ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Add Category </a>
                                    </div>
                                </div>
