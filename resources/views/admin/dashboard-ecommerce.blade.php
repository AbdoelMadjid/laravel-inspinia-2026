...
@section('title', 'eCommerce Dashboard | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-xxl-4">
                                            ...
                                            <div class="text-center my-3">
                                                <a href="{{ route('page', 'chat') }}" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Reports <i class="ti ti-send-2"></i> </a>
                                            </div>
                                        </div>
                                        <!-- end col-->
                                    </div>
                            ...
                            <div data-table data-table-rows-per-page="5" class="card">
                                <div class="card-header justify-content-between align-items-center border-dashed">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="#!" class="btn btn-sm btn-soft-secondary"> <i class="ti ti-plus me-1"></i> Add Product </a>
                                        <a href="javascript:void(0);" class="btn btn-sm btn-primary"> <i class="ti ti-file-export me-1"></i> Export CSV </a>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-centered table-custom table-sm table-nowrap table-hover mb-0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/products/1.png') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">Smart Watch</a></h5>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 class="fs-base mt-1 fw-normal">
                                                            ...
                                                            <span class="ms-1"><a href="#!" class="link-reset fw-semibold">(45)</a></span>
                                                        </h5>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/products/2.png') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">Bluetooth Speaker</a></h5>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 class="fs-base mt-1 fw-normal">
                                                            ...
                                                            <span class="ms-1"><a href="#!" class="link-reset fw-semibold">(20)</a></span>
                                                        </h5>
                                                    </td>
                                                    <td>
                                                        <span class="text-muted fs-xs">Status</span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/products/4.png') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">Gaming Mouse</a></h5>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 class="fs-base mt-1 fw-normal">
                                                            ...
                                                            <span class="ms-1"><a href="#!" class="link-reset fw-semibold">(14)</a></span>
                                                        </h5>
                                                    </td>
                                                    <td>
                                                        <span class="text-muted fs-xs">Status</span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/products/5.png') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">4K Action Camera</a></h5>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 class="fs-base mt-1 fw-normal">
                                                            ...
                                                            <span class="ms-1"><a href="#!" class="link-reset fw-semibold">(31)</a></span>
                                                        </h5>
                                                    </td>
                                                    <td>
                                                        <span class="text-muted fs-xs">Status</span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/products/6.png') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">Fitness Tracker Band</a></h5>
                                                                <span class="text-muted fs-xs">Wearables</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 class="fs-base mt-1 fw-normal">
                                                            ...
                                                            <span class="ms-1"><a href="#!" class="link-reset fw-semibold">(18)</a></span>
                                                        </h5>
                                                    </td>
                                                    <td>
                                                        <span class="text-muted fs-xs">Status</span>
                        ...
                        <div class="col-xxl-6">
                            <div data-table data-table-rows-per-page="5" class="card">
                                <div class="card-header justify-content-between align-items-center border-dashed">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="javascript:void(0);" class="btn btn-sm btn-soft-secondary"> <i class="ti ti-plus me-1"></i> Add Order </a>
                                        <a href="javascript:void(0);" class="btn btn-sm btn-primary"> <i class="ti ti-file-export me-1"></i> Export CSV </a>
                                    </div>
                                </div>
                                <div class="card-body p-0">
                                        ...
                                        <table class="table table-centered table-custom table-sm table-nowrap table-hover mb-0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">#ORD-1001</a></h5>
                                                    ...
                                                    <td>
                                                        <span class="text-muted fs-xs">Status</span>
                                                        <h5 class="fs-base mt-1 fw-normal"><i class="ti ti-circle-filled fs-xs text-success"></i> Delivered</h5>
                                                    </td>
                                                    <td style="width: 30px">
                                                        <div class="dropdown">
                                                            <a href="#" class="dropdown-toggle text-muted drop-arrow-none card-drop p-0" data-bs-toggle="dropdown">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">#ORD-1002</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">#ORD-1003</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">#ORD-1004</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                            <div>
                                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">#ORD-1005</a></h5>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-xl-6">
                                                ...
                                                <table class="table table-custom table-nowrap table-hover table-centered mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="badge badge-soft-success fs-xxs"><i class="ti ti-point-filled"></i> Paid</span>
                                                            </td>
                                                            <td><img src="{{ asset('assets/images/cards/mastercard.svg') }}" alt="" class="me-2" height="28" /> xxxx 1123</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="badge badge-soft-danger fs-xxs"><i class="ti ti-point-filled"></i> Failed</span>
                                                            </td>
                                                            <td><img src="{{ asset('assets/images/cards/visa.svg') }}" alt="" class="me-2" height="28" /> xxxx 3490</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><img src="{{ asset('assets/images/cards/american-express.svg') }}" alt="" class="me-2" height="28" /> xxxx 8765</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="badge badge-soft-warning fs-xxs"><i class="ti ti-point-filled"></i> Pending</span>
                                                            </td>
                                                            <td><img src="{{ asset('assets/images/cards/mastercard.svg') }}" alt="" class="me-2" height="28" /> xxxx 5566</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><img src="{{ asset('assets/images/cards/visa.svg') }}" alt="" class="me-2" height="28" /> xxxx 9012</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            ...
                                            <div class="text-center mt-3">
                                                <a href="#!" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View All Transactions <i class="ti ti-send-2"></i> </a>
                                            </div>
                                        </div>
                                        <!-- end col-->
                                        <div class="col-xl-6">
