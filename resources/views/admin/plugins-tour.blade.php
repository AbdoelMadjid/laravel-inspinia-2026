...
@section('title', 'Tour | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@push('styles')
    <link href="{{ asset('assets/plugins/tourguidejs/tour.min.css') }}" rel="stylesheet" />
@endpush
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="text-center mt-4 mb-5">
                                                    ...
                                                    <p class="text-muted fs-sm">
                                                        Our admin panel provides a robust foundation for modern web apps. With support for multiple frameworks and over a dozen demo variations, developers can build exactly what they need, fast and easily. Customize with ease and
                                                        enjoy consistent UI across projects.
                                                    </p>
                                                    ...
                                                    <div class="d-flex justify-content-center mt-4 flex-wrap gap-2">
                                                        ...
                                                        <a href="#!" target="_blank" class="btn btn-danger" data-tg-order="2" data-tg-tour="Ready to supercharge your project? Click here to purchase the template!" data-tg-title="Buy Now">
                                        ...
                                        <div data-tg-order="3" data-tg-tour="Learn more about the versatile services and modules we provide to enhance development." data-tg-title="Core Features">
                                            <div class="row">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/plugins-tour.js') }}"></script>
@endpush
