...
@section('title', 'Apex Column Charts | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('scripts')
    ...
    <script src="{{ asset('assets/plugins/dayjs/1.11.0/dayjs.min.js') }}"></script>
    <script src="{{ asset('assets/plugins/dayjs/1.11.0/plugin/quarterOfYear.min.js') }}"></script>
    <script src="{{ asset('assets/js/pages/chart-apex-column.js') }}"></script>
@endpush
