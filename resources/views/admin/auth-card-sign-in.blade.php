                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <a href="{{ route('page', 'auth-card-reset-pass') }}" class="text-decoration-underline link-offset-3 text-muted">Forgot Password?</a>
                                            </div>
                                        ...
                                        <p class="text-muted text-center mt-4 mb-0">
                                            New here?
                                            <a href="{{ route('page', 'auth-card-sign-up') }}" class="text-decoration-underline link-offset-3 fw-semibold">Create an account</a>
                                        </p>
