...
@section('title', 'Basic Datatables | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@push('styles')
    <link href="{{ asset('assets/plugins/datatables/fixedColumns.bootstrap5.min.css') }}" rel="stylesheet" type="text/css" />
@endpush
...
@push('scripts')
    ...
    <script src="{{ asset('assets/plugins/datatables/fixedColumns.bootstrap5.min.js') }}"></script>
    <script src="{{ asset('assets/js/pages/datatables-fixed-columns.js') }}"></script>
@endpush
