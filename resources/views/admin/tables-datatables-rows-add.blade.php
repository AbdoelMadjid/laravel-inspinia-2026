...
@section('title', 'Add New Row Datatables | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/datatables-rows-add.js') }}"></script>
@endpush
