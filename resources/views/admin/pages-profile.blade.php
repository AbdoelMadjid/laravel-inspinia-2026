                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <div class="avatar avatar-xxl">
                                                <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="avatar-2" class="img-fluid img-thumbnail rounded-circle" />
                                            </div>
                                            <div>
                                                <h4 class="text-nowrap fw-bold mb-1">Damian D.</h4>
                                                <p class="text-muted mb-1">Product Designer</p>
                                                <span class="badge badge-soft-primary fw-medium fs-xs ms-auto">Author</span>
                                            </div>
                                        </div>
