...
@section('title', 'Profile | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="avatar-3" class="img-fluid rounded" />
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            <a href="#!" class="btn btn-sm btn-icon btn-primary" title="Message">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="avatar-4" class="img-fluid rounded" />
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            <a href="#!" class="btn btn-sm btn-icon btn-outline-primary" title="Accept">
                                                <i class="ti ti-check fs-lg"></i>
                                            </a>
                                            <a href="#!" class="btn btn-sm btn-icon btn-danger" title="Decline">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="avatar-5" class="img-fluid rounded" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="avatar-6" class="img-fluid rounded" />
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            <a href="#!" class="btn btn-sm btn-icon btn-outline-secondary" title="View">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="avatar-7" class="img-fluid rounded" />
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            <a href="#!" class="btn btn-sm btn-icon btn-outline-primary" title="Join">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="avatar-8" class="img-fluid rounded" />
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            <a href="#!" class="btn btn-sm btn-icon btn-outline-info" title="Check">
                                                <i class="ti ti-bell fs-lg"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-9.jpg') }}" alt="avatar-9" class="img-fluid rounded" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-10.jpg') }}" alt="avatar-10" class="img-fluid rounded" />
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            <a href="#!" class="btn btn-sm btn-icon btn-outline-primary">
                                                <i class="ti ti-user-check fs-lg"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="avatar-1" class="img-fluid rounded" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm">
                                                <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="avatar-2" class="img-fluid rounded" />
                                            </div>
                                            <div>
                        ...
                        <div class="col-xl-8">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center gap-2 my-3">
                                                ...
                                                <span class="badge badge-soft-primary fw-medium fs-xs ms-auto">+3 New</span>
                                            </div>
                                            <p class="mb-0">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center gap-2 my-3">
                                                ...
                                                <span class="badge badge-soft-secondary fw-medium fs-xs ms-auto">+5 New</span>
                                            </div>
                                            <p class="mb-0">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center gap-2 my-3">
                                                ...
                                                <span class="badge badge-soft-secondary fw-medium fs-xs ms-auto">+4 New</span>
                                            </div>
                                            <p class="mb-0">
                                                <span class="text-secondary">
                                                    <i class="ti ti-circle align-middle"></i>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center gap-2 my-3">
                                                ...
                                                <span class="badge badge-soft-primary fw-medium fs-xs ms-auto">+1.5%</span>
                                            </div>
                                            <p class="mb-0">
                                                <span class="text-primary">
                                                    <i class="ti ti-circle align-middle"></i>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p>
                                        I'm a Product Designer and template author passionate about crafting clean, scalable, and high-performing UI solutions. With a focus on frontend technologies and modern design systems, I create user-centric digital products that are both
                                        functional and visually appealing.
                                    </p>
                                    <p class="mb-0">
                                        As a template creator, I specialize in building developer-friendly UI kits and dashboards using frameworks like Tailwind CSS, Bootstrap, React, Next.js, Vue, and Laravel. My work powers countless web apps, helping developers save time and
                                        build faster.
                                    </p>
                                        ...
                                        <table class="table table-centered table-custom table-sm table-nowrap table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h5 class="fs-sm my-1">
                                                            <a data-sort="task" href="#" class="text-body">Admin Dashboard Template - Final Touch</a>
                                                        </h5>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                                            <div class="avatar avatar-sm">
                                                                <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="avatar-3" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                    ...
                                                    <td>8h 45min</td>
                                                    <td>
                                                        <a href="javascript: void(0);" class="text-muted fs-xxl">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="fs-sm my-1">
                                                            <a data-sort="task" href="#" class="text-body">Tailwind UI Kit Design</a>
                                                        </h5>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                                            <div class="avatar avatar-sm">
                                                                <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="avatar-5" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="fs-sm my-1">
                                                            <a data-sort="task" href="#" class="text-body">React + Next.js Starter Template</a>
                                                        </h5>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                                            <div class="avatar avatar-sm">
                                                                <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="avatar-2" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="fs-sm my-1">
                                                            <a data-sort="task" href="#" class="text-body">Laravel Template Docs Update</a>
                                                        </h5>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                                            <div class="avatar avatar-sm">
                                                                <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="avatar-1" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="fs-sm my-1">
                                                            <a data-sort="task" href="#" class="text-body">Portfolio Website Redesign</a>
                                                        </h5>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                                            <div class="avatar avatar-sm">
                                                                <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="avatar-6" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-md-6">
                                    <article class="card rounded-3">
                                        ...
                                        <!-- Card image -->
                                        <img class="card-img-top rounded-top-3" src="{{ asset('assets/images/blog/blog-4.jpg') }}" alt="Tech Innovations" />

                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <!-- Title -->
                                            <h6 class="card-title fs-lg lh-base mb-2">
                                                <a href="#!" class="link-reset">The Future of Artificial Intelligence</a>
                                            </h6>
                                        ...
                                        <div class="card-footer bg-transparent d-flex justify-content-between">
                                            <div class="d-flex justify-content-start align-items-center gap-2">
                                                <div class="avatar avatar-xs">
                                                    <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="avatar-4" class="img-fluid rounded-circle" />
                                                </div>
                                                <div>
                                            ...
                                            <a class="link-primary fw-semibold d-flex align-items-center gap-1" href="#!">
                                                Read more
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <article class="card rounded-3">
                                        ...
                                        <!-- Card image -->
                                        <img class="card-img-top rounded-top-3" src="{{ asset('assets/images/blog/blog-5.jpg') }}" alt="Data Science Trends" />

                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <!-- Title -->
                                            <h6 class="card-title fs-lg lh-base mb-2">
                                                <a href="#!" class="link-reset">Top Data Science Trends in 2025</a>
                                            </h6>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <article class="card rounded-3">
                                        ...
                                        <!-- Card image -->
                                        <img class="card-img-top rounded-top-3" src="{{ asset('assets/images/blog/blog-3.jpg') }}" alt="Entrepreneur Tips" />

                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <!-- Title -->
                                            <h6 class="card-title fs-lg lh-base mb-2">
                                                <a href="#!" class="link-reset">5 Key Tips for New Entrepreneurs</a>
                                            </h6>
                                        ...
                                        <div class="card-footer bg-transparent d-flex justify-content-between">
                                            <div class="d-flex justify-content-start align-items-center gap-2">
                                                <div class="avatar avatar-xs">
                                                    <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="avatar-7" class="img-fluid rounded-circle" />
                                                </div>
                                                <div>
                                                    <h5 class="text-nowrap fs-sm mb-0 lh-base">
...
<form id="pages-profile-avatar-form" class="d-none">
    @csrf
    <input type="file" id="pages-profile-avatar-input-file" name="avatar" accept="image/*" onchange="uploadProfilePageAvatar(this)" />
</form>
...
function triggerProfileAvatarUpload() {
    document.getElementById('pages-profile-avatar-input-file').click();
}
