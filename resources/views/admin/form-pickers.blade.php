...
@section('title', 'Form Picker | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/plugins/daterangepicker/daterangepicker.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('assets/plugins/pickr/classic.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/plugins/pickr/monolith.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/plugins/pickr/nano.min.css') }}" />
@endpush
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2">A versatile JavaScript component for selecting date ranges, single dates, and times with ease. Perfect for forms and dashboards, it supports calendar views, time pickers, and predefined ranges.</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2">Lightweight, powerful javascript datetimepicker with no dependencies</p>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/form-colorpickr.js') }}"></script>
@endpush
