...
@section('title', 'Role Details | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@section('content')
<div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Role Details</h4>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <div class="avatar-group avatar-group-sm mb-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-9.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-10.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR76129</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-1.jpg') }}" class="img-fluid rounded-circle" alt="Elena Carter" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Elena Carter</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR58647</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="img-fluid rounded-circle" alt="Jordan Smith" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Jordan Smith</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR94715</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" class="img-fluid rounded-circle" alt="Lucas Brown" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Lucas Brown</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR40289</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="img-fluid rounded-circle" alt="Sophia Green" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Sophia Green</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR23981</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-5.jpg') }}" class="img-fluid rounded-circle" alt="Ethan Ross" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Ethan Ross</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    17 Jul, 2025
                                                    <small class="text-muted">5:55 PM</small>
                                                </td>
                                                <td>
                                                    <span class="badge bg-warning-subtle text-warning badge-label">Inactive</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR83742</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" class="img-fluid rounded-circle" alt="Zara Mitchell" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Zara Mitchell</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR51268</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" class="img-fluid rounded-circle" alt="Benjamin Gray" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Benjamin Gray</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    20 Jul, 2025
                                                    <small class="text-muted">6:25 PM</small>
                                                </td>
                                                <td>
                                                    <span class="badge bg-warning-subtle text-warning badge-label">Inactive</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR17456</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-8.jpg') }}" class="img-fluid rounded-circle" alt="Ava Patel" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Ava Patel</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR96421</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-9.jpg') }}" class="img-fluid rounded-circle" alt="Mason Rivera" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Mason Rivera</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">#USR71539</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('assets/images/users/user-10.jpg') }}" class="img-fluid rounded-circle" alt="Chloe Walker" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-base mb-0">
                                                                <a href="{{ route('page', 'apps-users-profile') }}" class="link-reset">Chloe Walker</a>
                                                            </h5>
