...
@section('title', 'Create New Products | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/ecommerce-product-add.js') }}"></script>
@endpush
