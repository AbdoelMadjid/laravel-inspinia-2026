...
@section('title', 'Widgets | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@section('content')
<div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Widgets</h4>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-end mt-3">
                                        <a href="{{ route('page', 'chat') }}" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Links <i class="ti ti-link"></i> </a>
                                    </div>
                                </div>
                                <!-- end card-body-->
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/flags/de.svg') }}" alt="Germany" class="avatar-xxs rounded" />
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/flags/fr.svg') }}" alt="France" class="avatar-xxs rounded" />
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/flags/in.svg') }}" alt="India" class="avatar-xxs rounded" />
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/flags/us.svg') }}" alt="United States" class="avatar-xxs rounded" />
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/flags/gb.svg') }}" alt="United Kingdom" class="avatar-xxs rounded" />
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/flags/ca.svg') }}" alt="Canada" class="avatar-xxs rounded" />
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/flags/jp.svg') }}" alt="Japan" class="avatar-xxs rounded" />
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/flags/au.svg') }}" alt="Australia" class="avatar-xxs rounded" />
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/flags/br.svg') }}" alt="Brazil" class="avatar-xxs rounded" />
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <img src="{{ asset('assets/images/flags/it.svg') }}" alt="Italy" class="avatar-xxs rounded" />
                                    ...
                                    <div class="text-center mt-2">
                                        <a href="{{ route('page', 'chat') }}" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Countries <i class="ti ti-world"></i> </a>
                                    </div>
                                </div>
                                <!-- end card-body -->
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card border-top-0">
                                <div class="position-relative card-side-img overflow-hidden rounded-top" style="height: 180px; background-image: url({{ asset('assets/images/profile-bg.jpg') }})">
                                ...
                                <div class="card-body position-relative">
                                    <div class="d-flex justify-content-start gap-3">
                                        <div class="avatar avatar-xxl" style="margin-top: -60px">
                                            <a href="#!">
                                                <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="User Profile" class="img-fluid img-thumbnail rounded-circle" />
                                            </a>
                                        </div>
                                        <div>
                                            <h4 class="text-nowrap fw-bold mb-1">
                                                <a href="#!" class="text-reset text-decoration-none">Damian D.</a>
                                            </h4>
                                ...
                                <div class="card-body">
                                    <div class="d-flex border border-dashed rounded p-3">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="" class="avatar-sm rounded-circle shadow-sm" />
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="d-flex justify-content-between mt-2 text-muted">
                                                ...
                                                <a href="javascript:void(0);" class="link-primary fw-semibold d-inline-flex align-items-center gap-1"> <i class="ti ti-arrow-back-up"></i> Reply </a>
                                            </div>

                                            <!-- Nested Comment -->
                                            <div class="d-flex mt-4">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/user-10.jpg') }}" alt="" class="avatar-sm rounded-circle shadow-sm" />
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="d-flex mt-4">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="" class="avatar-sm rounded-circle shadow-sm" />
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body py-0" style="height: 380px" id="chat-container" data-simplebar data-simplebar-md>
                                    ...
                                    <div class="d-flex align-items-start gap-2 my-3 chat-item">
                                        <img src="{{ asset('assets/images/users/user-5.jpg') }}" class="avatar-md rounded-circle" alt="User" />
                                        <div>
                                    ...
                                    <div class="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                                        ...
                                        <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-md rounded-circle" alt="User" />
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pb-2">
                                        ...
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pb-2">
                                        ...
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-10.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                        </div>
                                        <div>
                                            <a href="#" class="btn btn-sm btn-icon btn-default" title="Download"><i class="ti ti-download fs-lg"></i></a>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pb-2">
                                        ...
                                        <div class="avatar-group avatar-group-xs">
                                            ...
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                            <div class="avatar"><img src="{{ asset('assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs" alt="" /></div>
                                        </div>
                                        <div>
                                            <a href="#" class="btn btn-sm btn-icon btn-default" title="Download"><i class="ti ti-download fs-lg"></i></a>
                                ...
                                <div class="card-body">
                                    <div class="pb-2 border-bottom border-light border-dashed">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="avatar-group avatar-group-xs">
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="Liam Carter" class="avatar-xs rounded-circle" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="Zoe Miles" class="avatar-xs rounded-circle" />
                                                </div>
                                                <div class="avatar avatar-xs">
                                                    <span class="avatar-title bg-primary-subtle text-primary rounded-circle fw-bold"> D </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="py-2 border-bottom border-light border-dashed">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="avatar-group avatar-group-xs">
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="Ava Lee" class="avatar-xs rounded-circle" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="Ethan King" class="avatar-xs rounded-circle" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-9.jpg') }}" alt="Lucas White" class="avatar-xs rounded-circle" />
                                                </div>
                                            </div>
                                            <button type="button" class="btn btn-sm btn-soft-secondary rounded-circle btn-icon">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        <span class="float-end"
                                            ><b><span data-target="1,479">0</span></b></span
                                        >
                                    </p>
                                </div>
                                <!-- end card-body-->
