...
@section('title', 'Text Diff | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@section('content')
<div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Text Diff</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Text Diff</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="code-body">
                           ...
                           <code class="language-markup">
                            &lt;div class=&quot;row&quot;&gt;
                                &lt;div class=&quot;col-md-4&quot;&gt;
                                    &lt;h4 class=&quot;mb-2&quot;&gt;Original text&lt;/h4&gt;
                            ...
                            &lt;!-- Find Javascript in File: assets/js/pages/plugins-text-diff.js --&gt;
...
@push('scripts')
    <script src="{{ asset('assets/plugins/diff/diff.min.js') }}"></script>
    <script src="{{ asset('assets/js/pages/plugins-text-diff.js') }}"></script>
@endpush
