                                    ...
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="{{ route('page', 'apps-users-role-details') }}" class="btn btn-sm btn-outline-primary rounded-pill">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="avatar-group avatar-group-sm mb-3">
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="avatar-group avatar-group-sm mb-3">
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-10.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="avatar-group avatar-group-sm mb-3">
                                                ...
                                                <div class="avatar">
                                                    <img src="{{ asset('assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-sm" alt="" />
                                                </div>
                                            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm">
                                                                    <img src="{{ asset('assets/images/users/user-9.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                                                </div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm">
                                                                    <img src="{{ asset('assets/images/users/user-10.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                                                </div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
