...
@section('title', 'Projects | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                ...
                                <div class="row gap-3">
                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('page', 'apps-projects-grid') }}" class="btn btn-primary btn-icon">
                                                <i class="ti ti-category fs-lg"></i>
                                            </a>
                                            <a href="{{ route('page', 'apps-projects-list') }}" class="btn btn-soft-primary btn-icon">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-4">
                                        <div class="avatar-xl me-3">
                                            <span class="avatar-title text-bg-light rounded">
                                                <i class="ti ti-code fs-24 text-muted"></i>
                                            </span>
                                        </div>
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ route('page', 'apps-projects-details') }}" class="link-reset">AI Analytics Dashboard</a>
                                            </h5>
                                    ...
                                    <div class="avatar-group avatar-group-xs mb-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-4">
                                        <div class="avatar-xl me-3">
                                            <span class="avatar-title text-bg-light rounded">
                                                <i class="ti ti-speakerphone fs-24 text-muted"></i>
                                            </span>
                                        </div>
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ route('page', 'apps-projects-details') }}" class="link-reset">Marketing Automation Platform</a>
                                            </h5>
                                    ...
                                    <div class="avatar-group avatar-group-xs mb-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-4">
                                        <div class="avatar-xl me-3">
                                            <span class="avatar-title text-bg-light rounded">
                                                <i class="ti ti-world fs-24 text-muted"></i>
                                            </span>
                                        </div>
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ route('page', 'apps-projects-details') }}" class="link-reset">Website Redesign</a>
                                            </h5>
                                    ...
                                    <div class="avatar-group avatar-group-xs mb-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-9.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-4">
                                        <div class="avatar-xl me-3">
                                            <span class="avatar-title text-bg-light rounded">
                                                <i class="ti ti-chart-bar fs-24 text-muted"></i>
                                            </span>
                                        </div>
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ route('page', 'apps-projects-details') }}" class="link-reset">Sales Insight Tool</a>
                                            </h5>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="d-flex align-items-center gap-2 mb-3">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    12/50
                                                    <span class="badge bg-secondary">+2 New</span>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="avatar-group avatar-group-xs mb-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-header bg-light-subtle border-light p-3">
                                    <div class="avatar-xl me-3">
                                        <span class="avatar-title text-bg-light rounded-circle">
                                            <i class="ti ti-bulb fs-24 text-muted"></i>
                                        </span>
                                    </div>
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="{{ route('page', 'apps-projects-details') }}" class="link-reset">Cyber Security System</a>
                                        </h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="avatar-group avatar-group-xs mb-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                        ...
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-header bg-light-subtle border-light p-3">
                                    <div class="avatar-xl me-3">
                                        <span class="avatar-title text-bg-light rounded-circle">
                                            <i class="ti ti-device-desktop fs-24 text-muted"></i>
                                        </span>
                                    </div>
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="{{ route('page', 'apps-projects-details') }}" class="link-reset">AI Performance Dashboard</a>
                                        </h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="avatar-group avatar-group-xs mb-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                        ...
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-header bg-light-subtle border-light p-3">
                                    <div class="avatar-xl me-3">
                                        <span class="avatar-title text-bg-light rounded-circle">
                                            <i class="ti ti-cloud-upload fs-24 text-muted"></i>
                                        </span>
                                    </div>
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="{{ route('page', 'apps-projects-details') }}" class="link-reset">Cloud Sync Platform</a>
                                        </h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="avatar-group avatar-group-xs mb-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-10.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs" alt="" />
                                        </div>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-header bg-light-subtle border-light p-3">
                                    <div class="avatar-xl me-3">
                                        <span class="avatar-title text-bg-light rounded-circle">
                                            <i class="ti ti-database fs-24 text-muted"></i>
                                        </span>
                                    </div>
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="{{ route('page', 'apps-projects-details') }}" class="link-reset">Data Mining Toolkit</a>
                                        </h5>
