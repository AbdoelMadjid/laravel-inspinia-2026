...
@section('title', 'Placeholders | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2">Use loading placeholders for your components or pages to indicate something may still be loading.</p>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card border shadow-none mb-md-0">
                                                    <!-- card-img-top -->
                                                    <img src="{{ asset('assets/images/stock/small-1.jpg') }}" class="card-img-top" alt="..." />
