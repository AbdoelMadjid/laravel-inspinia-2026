...
@section('title', 'Blog List | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    <div class="row g-5">
                                        <!-- Main content START -->
                                        <div class="col-lg-8">
                                            <article class="card flex-md-row mb-3">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('assets/images/blog/blog-1.jpg') }}" class="w-100 h-100 object-fit-cover" alt="Building APIs" />
                                                    </div>
                                                </div>
                                            ...
                                            <article class="card flex-md-row mb-3">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('assets/images/blog/blog-2.jpg') }}" class="w-100 h-100 object-fit-cover" alt="UI Design Tips" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ route('page', 'apps-blog-article') }}" class="link-reset">10 Essential UI Design Tips for Better User Experience</a>
                                                        </h6>
                                            ...
                                            <article class="card flex-md-row mb-3">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('assets/images/blog/blog-3.jpg') }}" class="w-100 h-100 object-fit-cover" alt="AI in Web Development" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ route('page', 'apps-blog-article') }}" class="link-reset">How AI is Transforming Modern Web Development</a>
                                                        </h6>
                                            ...
                                            <article class="card flex-md-row mb-3">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('assets/images/blog/blog-4.jpg') }}" class="w-100 h-100 object-fit-cover" alt="Content Marketing Strategies" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ route('page', 'apps-blog-article') }}" class="link-reset">Top 5 Content Marketing Strategies That Work in 2025</a>
                                                        </h6>
                                            ...
                                            <article class="card flex-md-row mb-3">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('assets/images/blog/blog-5.jpg') }}" class="w-100 h-100 object-fit-cover" alt="Startup Growth" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ route('page', 'apps-blog-article') }}" class="link-reset">Scaling Your Startup: Lessons from Successful Founders</a>
                                                        </h6>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="d-grid mb-4">
                                                <a href="{{ route('page', 'apps-blog-add') }}" class="btn btn-primary btn-lg fs-base d-flex align-items-center justify-content-center gap-2"> <i class="ti ti-circle-dashed-plus"></i> Add New Article </a>
                                            </div>
