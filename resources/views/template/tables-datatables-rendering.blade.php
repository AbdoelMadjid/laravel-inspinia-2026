...
@section('title', 'Data Rendering Datatables | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/datatables-rendering.js') }}"></script>
@endpush
