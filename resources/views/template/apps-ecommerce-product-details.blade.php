...
@section('title', 'Product Details | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="card card-top-sticky border-0">
                                                <div class="card-body p-0">
                                                    ...
                                                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                                        <div class="carousel-inner bg-light bg-opacity-25 border border-light border-dashed rounded-3" role="listbox">
                                                            <div class="carousel-item text-center active">
                                                                <img src="{{ asset('assets/images/products/single-1.png') }}" alt="" class="img-fluid" />
                                                            </div>
                                                            <div class="carousel-item text-center">
                                                                <img src="{{ asset('assets/images/products/single-2.png') }}" alt="" class="img-fluid" />
                                                            </div>
                                                            <div class="carousel-item text-center">
                                                                <img src="{{ asset('assets/images/products/single-3.png') }}" alt="" class="img-fluid" />
                                                            </div>
                                                            <div class="carousel-item text-center">
                                                                <img src="{{ asset('assets/images/products/single-4.png') }}" alt="" class="img-fluid" />
                                                            </div>
                                                        </div>
                                                        <div class="carousel-indicators m-0 mt-3 d-lg-flex d-none position-static h-100 rounded gap-2">
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1" class="h-auto rounded bg-light-subtle border active" style="width: auto !important">
                                                                <img src="{{ asset('assets/images/products/single-1.png') }}" class="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="1" aria-label="Slide 2" class="h-auto rounded bg-light-subtle border" style="width: auto !important">
                                                                <img src="{{ asset('assets/images/products/single-2.png') }}" class="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="2" aria-label="Slide 3" class="h-auto rounded bg-light-subtle border" style="width: auto !important">
                                                                <img src="{{ asset('assets/images/products/single-3.png') }}" class="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="3" aria-label="Slide 4" class="h-auto rounded bg-light-subtle border" style="width: auto !important">
                                                                <img src="{{ asset('assets/images/products/single-4.png') }}" class="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <!-- end carousel-->
                                                    ...
                                                    <div class="text-center my-3">
                                                        <a href="{{ route('page', 'apps-ecommerce-product-add') }}" class="btn btn-light me-1">
                                                            <i class="ti ti-pencil fs-lg me-1"></i>
                                                            Edit
                                                        </a>
                                                        <a href="{{ route('page', 'apps-ecommerce-product-add') }}" class="btn btn-danger">
                                        ...
                                        <div class="col-xl-8">
                                            <div class="p-4">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="flex-grow-1 d-inline-flex align-items-center justify-content-end fs-lg">
                                                        ...
                                                        <span class="ms-1 fs-base">
                                                            <a href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-medium">(859 Reviews)</a>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="mt-3 mb-5">
                                                ...
                                                <p>
                                                    Relax in style with the Azure Comfort Single Sofa. Crafted with premium materials and a rich blue fabric, this single-seater is designed for both luxury and durability. Its sleek, modern profile fits perfectly in living rooms,
                                                    reading nooks, or stylish lounges.
                                                </p>
                                                        ...
                                                        <div class="row align-items-center g-0">
                                                            <div class="col-xl-7">
                                                                <div class="d-flex align-items-center gap-4 p-4">
                                                                    <img src="{{ asset('assets/images/ratings.svg') }}" alt="Product" height="80" />
                                                                    <div>
