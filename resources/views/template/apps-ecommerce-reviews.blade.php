...
@section('title', 'Reviews | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                            ...
                                            <div class="row align-items-center g-0">
                                                <div class="col-xl-7">
                                                    <div class="d-flex align-items-center gap-4 p-4">
                                                        ...
                                                        <div>
                                                            <h3 class="text-primary d-flex align-items-center gap-2 mb-2 fw-bold">4.92 <i class="ti ti-star-filled"></i></h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Smart Watch</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">4K Ultra HD TV</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Smartphone X</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Gaming Laptop</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/ecommerce-reviews.js') }}"></script>
@endpush
