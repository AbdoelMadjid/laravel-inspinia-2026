...
@section('title', 'Nestable List | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@section('content')
<div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Sortable List</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Sortable List</li>
                            </ol>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/plugins-nestable.js') }}"></script>
@endpush
