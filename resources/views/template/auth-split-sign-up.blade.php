...
@section('title', 'Create New Account | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                    ...
                    <div class="card auth-box-form border-0 mb-0">
                        <div class="card-body min-vh-100 d-flex flex-column justify-content-center">
                            ...
                            <p class="text-muted text-center mt-4 mb-0">
                                ...
                                <a href="{{ route('page', 'auth-split-sign-in') }}" class="text-decoration-underline link-offset-3 fw-semibold">Login</a>
                            </p>
