...
@section('title', 'Activity Stream | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                ...
                                <div class="card-body">
                                    <div class="pb-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Olivia Lee
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Ethan Wong
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Grace Kim
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Noah Smith
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Mia Johnson
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Liam Davis
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Sophia Martinez
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Jack Wilson
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-9.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Ella Moore
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('assets/images/users/user-10.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Benjamin Taylor
                                        </a>
                                    ...
                                    <div class="timeline timeline-icon-bordered">
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3 pb-3">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="Sophia Reed" class="rounded-circle avatar-xxs" />
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="Daniel Chen" class="rounded-circle avatar-xxs" />
