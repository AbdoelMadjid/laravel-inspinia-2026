...
@section('title', 'Show & Hide Columns Datatables | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/datatables-show-hide-columns.js') }}"></script>
@endpush
