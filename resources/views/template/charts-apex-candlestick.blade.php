...
@section('title', 'Apex Candlestick Charts | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/samples/ohlc.js') }}"></script>
    <script src="{{ asset('assets/plugins/dayjs/1.8.17/dayjs.min.js') }}"></script>
    <script src="{{ asset('assets/js/pages/chart-apex-candlestick.js') }}"></script>
@endpush
