...
@section('title', 'Analytics Dashboard | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                                ...
                                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                                    <div class="p-3 rounded m-1 border border-dashed">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                <h3 class="mb-1">
                                                                    <span data-target="14.59">0</span>M <span class="text-success fs-base">+5.2% <i class="ti ti-trending-up"></i></span>
                                                                </h3>
                                                ...
                                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                                    <div class="p-3 rounded m-1 mt-xxl-0 border border-dashed">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                <h3 class="mb-1">
                                                                    <span data-target="815.58">0</span>k <span class="text-success fs-base">+3.9% <i class="ti ti-activity"></i></span>
                                                                </h3>
                                                ...
                                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                                    <div class="p-3 rounded m-1 mt-xxl-0 border border-dashed">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                <h3 class="mb-1">
                                                                    <span data-target="41.3">0</span>% <span class="text-danger fs-base">-1.1% <i class="ti ti-arrow-down-left"></i></span>
                                                                </h3>
                                                ...
                                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                                    <div class="p-3 rounded m-1 mt-xxl-0 border border-dashed">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                <h3 class="mb-1">
                                                                    <span data-target="56.39">0</span>k <span class="text-success fs-base">+2.3% <i class="ti ti-users"></i></span>
                                                                </h3>
                                        ...
                                        <div class="col-xxl-9 order-1 order-xxl-2 border-start border-dashed">
                                            <div class="card-header justify-content-between border-dashed">
                                                ...
                                                <div class="d-flex flex-wrap gap-1">
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-primary"> <i class="ti ti-download me-1"></i> Export CSV </a>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div dir="ltr">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="table-responsive">
                                                <table class="table table-custom table-nowrap table-hover table-centered mb-0">
                                                    ...
                                                    <tbody class="text-sm">
                                                        <tr>
                                                            <td><i class="ti ti-rocket text-primary me-1 fs-lg"></i> Spring Launch</td>
                                                            <td>502</td>
                                                            <td>260</td>
                                                            <td>6,845</td>
                                                        ...
                                                        <tr>
                                                            <td><i class="ti ti-brand-facebook text-info fs-lg me-1"></i> Facebook Push</td>
                                                            <td>478</td>
                                                            <td>245</td>
                                                            <td>6,120</td>
                                                        ...
                                                        <tr>
                                                            <td><i class="ti ti-speakerphone text-success fs-lg me-1"></i> Holiday Buzz</td>
                                                            <td>445</td>
                                                            <td>230</td>
                                                            <td>5,710</td>
                                                            <td>23.12%</td>
                                                        ...
                                                        <tr>
                                                            <td><i class="ti ti-mail-fast text-warning fs-lg me-1"></i> Email Reconnect</td>
                                                            <td>392</td>
                                                            <td>190</td>
                                                            <td>5,210</td>
                                                            <td>25.74%</td>
                                                        ...
                                                        <tr>
                                                            <td><i class="ti ti-broadcast text-muted fs-lg me-1"></i> Display Retarget</td>
                                                            <td>338</td>
                                                            <td>160</td>
                                                            <td>4,670</td>
                                                            <td>19.88%</td>
                        ...
                        <div class="d-block">
                            <div class="p-3 border-bottom">
                                ...
                                <a href="#" class="d-block py-2">
                                    ...
                                    <span class="d-flex align-items-center">
                                        <span class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="Lucas Miller" class="avatar-sm rounded-circle" />
                                        </span>
                                ...
                                <a href="#" class="d-block py-2">
                                    ...
                                    <span class="d-flex align-items-center">
                                        <span class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="Amelia Green" class="avatar-sm rounded-circle" />
                                        </span>
                                        <span class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <span class="d-flex align-items-center">
                                        <span class="flex-shrink-0">
                                            <span class="avatar avatar-sm d-block">
                                                <span class="avatar-title bg-info-subtle text-info rounded-circle fw-bold"> S </span>
                                            </span>
                                        </span>
                                        <span class="flex-grow-1 ms-2 text-truncate">
                                ...
                                <a href="#" class="d-block py-2">
                                    ...
                                    <span class="d-flex align-items-center">
                                        <span class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="Noah Smith" class="avatar-sm rounded-circle" />
                                        </span>
                                        <span class="flex-grow-1 ms-2 text-truncate">
                                ...
                                <a href="#" class="d-block py-2">
                                    ...
                                    <span class="d-flex align-items-center">
                                        <span class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="Emma Johnson" class="avatar-sm rounded-circle" />
                                        </span>
                                        <span class="flex-grow-1 ms-2 text-truncate">
                                ...
                                <div class="text-center mt-2">
                                    <a href="{{ route('page', 'chat') }}" class="link-reset text-decoration-underline fw-semibold link-offset-3"> Go to Chat <i class="ti ti-message"></i> </a>
                                </div>
                            </div>
                            <!-- end Quick Message-->
                                ...
                                <div class="p-3">
                                    <div class="tab-content">
                                        <div class="tab-pane" id="Posts">
                                            ...
                                            <p class="fs-xs mb-0">You have published 260 posts this month, showing strong content activity across all categories.</p>
                                        ...
                                        <div class="tab-pane show active" id="Orders">
                                            ...
                                            <p class="fs-xs mb-0">A total of 421 orders have been placed, reflecting consistent demand for your products.</p>
                                            <div class="card-body">
                            ...
                            <div class="p-3">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a href="#" class="text-muted d-flex align-items-center fs-xs fw-semibold"> <i class="ti ti-calendar me-1"></i><span>Invite</span> </a>
                                </div>
