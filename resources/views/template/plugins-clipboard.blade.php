...
@section('title', 'Clipboard | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
<div class="container-fluid">
                ...
                <!-- end contyainer-fluid-->
@endsection

@push('scripts')
    <script src="{{ asset('assets/plugins/clipboard/clipboard.min.js') }}"></script>
    <script src="{{ asset('assets/js/pages/plugins-clipboard.js') }}"></script>
@endpush
