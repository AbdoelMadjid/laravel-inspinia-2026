...
@section('title', 'Invoice Details | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                        ...
                                        <div class="card-body px-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-end">
                                                    <img src="{{ asset('assets/images/qr.png') }}" alt="Barcode" class="img-fluid" style="max-height: 80px" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <img src="{{ asset('assets/images/sign.png') }}" alt="Company Logo" height="42" />
