...
@section('title', 'Links | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2">Documentation and examples for Colored links with hover states.</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted">
                                            ...
                                            <a href="{{ route('page', 'ui-utilities') }}">
                                                <code>.text-*</code>
                                                classes
                                            </a>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted">
                                            <a href="{{ route('page', 'ui-utilities') }}">Colored link helpers</a>
