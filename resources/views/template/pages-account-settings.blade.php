...
@section('title', 'Account Settings | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                            ...
                            <article class="card card-out-of-container border-top-0">
                                <div class="position-relative card-side-img overflow-hidden" style="height: 250px; background-image: url({{ asset('assets/images/profile-bg.jpg') }})">
                                    <div class="p-4 card-img-overlay rounded-start-0 flex-column gap-2 auth-overlay d-flex align-items-center justify-content-center">
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger">Change Background</button>
                                    </div>
                                </div>
                            </article>
