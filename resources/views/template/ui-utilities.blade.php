...
@section('title', 'Utilities | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2">The utility API is a Sass-based tool to generate utility classes.</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <div class="text-bg-purple p-2">Purple with contrasting color (.text-bg-purple)</div>
                                        </div>
                                    </div>
                                    <!-- end card body -->
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start flex-wrap gap-2">
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded" alt="rounded" />
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-top" alt="rounded-top" />
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-end" alt="rounded-end" />
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-bottom" alt="rounded-bottom" />
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-start" alt="rounded-start" />
                                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-circle" alt="rounded-circle" />
                                            <img src="{{ asset('assets/images/stock/small-3.jpg') }}" class="w-auto rounded-pill" alt="rounded-pill" width="80" />
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start flex-wrap gap-2">
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-0" alt="rounded-0" />
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-1" alt="rounded-1" />
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-2" alt="rounded-2" />
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-3" alt="rounded-3" />
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-4" alt="rounded-4" />
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-5" alt="rounded-5" />
                                        </div>
                                    </div>
                                    <!--end card body-->
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap gap-4">
                                            ...
                                            <div class="overflow-visible p-3 bg-light" style="max-width: 260px; max-height: 100px">
                                                ...
                                                on an element with set width and height add more text dimensions premium admin dashboard template.
                                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start flex-wrap gap-3 text-center">
                                            <div>
                                                <img src="{{ asset('assets/images/stock/small-1.jpg') }}" class="object-fit-contain border rounded avatar-xl" alt="..." />
                                                <p class="mt-1 mb-0">
                                                    <code class="user-select-all">.object-fit-contain</code>
                                                </p>
                                            </div>
                                            <div>
                                                <img src="{{ asset('assets/images/stock/small-1.jpg') }}" class="object-fit-cover border rounded avatar-xl" alt="..." />
                                                <p class="mt-1 mb-0">
                                                    <code class="user-select-all">.object-fit-cover</code>
                                                </p>
                                            </div>
                                            <div>
                                                <img src="{{ asset('assets/images/stock/small-1.jpg') }}" class="object-fit-fill border rounded avatar-xl" alt="..." />
                                                <p class="mt-1 mb-0">
                                                    <code class="user-select-all">.object-fit-fill</code>
                                                </p>
                                            </div>
                                            <div>
                                                <img src="{{ asset('assets/images/stock/small-1.jpg') }}" class="object-fit-scale border rounded avatar-xl" alt="..." />
                                                <p class="mt-1 mb-0">
                                                    <code class="user-select-all">.object-fit-scale</code>
                                                </p>
                                            </div>
                                            <div>
                                                <img src="{{ asset('assets/images/stock/small-1.jpg') }}" class="object-fit-none border rounded avatar-xl" alt="..." />
                                                <p class="mt-1 mb-0">
