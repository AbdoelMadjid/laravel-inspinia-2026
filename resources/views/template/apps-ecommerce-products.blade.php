...
@section('title', 'Products | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                            ...
                            <div class="card mb-1">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center gap-2 my-3">
                                        ...
                                        <span class="badge badge-soft-primary fw-medium fs-xs ms-auto">+24 New</span>
                                    </div>
                                    <p class="mb-0">
                            ...
                            <div class="card mb-1">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center gap-2 my-3">
                                        ...
                                        <span class="badge badge-soft-secondary fw-medium fs-xs ms-auto">+120 New</span>
                                    </div>
                                    <p class="mb-0">
                            ...
                            <div class="card mb-1">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center gap-2 my-3">
                                        ...
                                        <span class="badge badge-soft-info fw-medium fs-xs ms-auto">+36 New</span>
                                    </div>
                                    <p class="mb-0">
                            ...
                            <div class="card mb-1">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center gap-2 my-3">
                                        ...
                                        <span class="badge badge-soft-warning fw-medium fs-xs ms-auto">+4.5%</span>
                                    </div>
                                    <p class="mb-0">
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('page', 'apps-ecommerce-products-grid') }}" class="btn btn-soft-primary btn-icon">
                                            <i class="ti ti-category fs-lg"></i>
                                        </a>
                                        <a href="{{ route('page', 'apps-ecommerce-products') }}" class="btn btn-soft-primary btn-icon active">
                                            <i class="ti ti-list-check fs-lg"></i>
                                        </a>
                                        <a href="{{ route('page', 'apps-ecommerce-product-add') }}" class="btn btn-danger ms-1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Wireless Earbuds</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(87)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ route('page', 'apps-ecommerce-product-details') }}" class="btn btn-light btn-icon btn-sm rounded-circle">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Smart LED Desk Lamp</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(54)</a>
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Men's Running Shoes</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(142)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('assets/images/products/4.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Fitness Tracker Watch</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(89)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('assets/images/products/5.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Gaming Mouse RGB</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(102)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('assets/images/products/6.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Modern Lounge Chair</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(27)</a>
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('assets/images/products/7.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Plush Toy Bear</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(120)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('assets/images/products/8.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">55" Ultra HD Smart TV</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(88)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('assets/images/products/9.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Apple iMac 24" M3</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(16)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-warning fs-xxs">Pending</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('assets/images/products/10.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Smart Watch Pro X2</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ route('page', 'apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(65)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
