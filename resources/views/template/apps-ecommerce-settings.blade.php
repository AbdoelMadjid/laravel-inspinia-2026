...
@section('title', 'Shop Settings | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                                        ...
                                                        <div class="tab-pane fade show active" id="shopStepGeneral">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-6 mb-3">
                                                                    ...
                                                                    <input type="email" class="form-control" placeholder="support@vona.com" required />
                                                                </div>
                                                                <div class="col-xl-6 mb-3">
