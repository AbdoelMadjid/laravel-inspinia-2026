...
@section('title', 'Products Grid | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                            ...
                            <form class="bg-light-subtle rounded border p-3">
                                <div class="d-flex flex-wrap justify align-items-center gap-3">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('page', 'apps-ecommerce-products-grid') }}" class="btn btn-soft-primary btn-icon active">
                                            <i class="ti ti-category fs-lg"></i>
                                        </a>
                                        <a href="{{ route('page', 'apps-ecommerce-products') }}" class="btn btn-soft-primary btn-icon">
