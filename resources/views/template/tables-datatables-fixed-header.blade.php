...
@section('title', 'Fixed Header Datatables | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')

@push('styles')
    <link href="{{ asset('assets/plugins/datatables/responsive.bootstrap5.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/plugins/datatables/fixedHeader.bootstrap5.min.css') }}" rel="stylesheet" type="text/css" />
@endpush
...
@push('scripts')
    ...
    <script src="{{ asset('assets/plugins/datatables/fixedHeader.bootstrap5.min.js') }}"></script>
    <script src="{{ asset('assets/js/pages/datatables-fixed-header.js') }}"></script>
@endpush
