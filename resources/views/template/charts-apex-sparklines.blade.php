...
@section('title', 'Sparkline Apexcharts | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/chart-apex-sparklines.js') }}"></script>
@endpush
