...
@section('title', 'Design Reviews & Feedback | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                        ...
                        <div class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
                            ...
                            <div class="card-header card-bg justify-content-between">
                                <div class="d-flex flex-wrap align-items-center gap-1">
                                    <!-- Back to Inbox -->
                                    <a href="{{ route('page', 'apps-email-inbox') }}" class="btn btn-default btn-icon btn-sm" data-bs-toggle="tooltip" title="Back to Inbox">
                                ...
                                <div class="pb-3">
                                    <div class="d-flex align-items-center">
                                        <a class="d-flex align-items-center flex-grow-1 text-reset" data-bs-toggle="collapse" href="#EmailOne" role="button" aria-expanded="false" aria-controls="EmailOne">
                                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" class="avatar-md rounded-circle" alt="User Avatar" />
