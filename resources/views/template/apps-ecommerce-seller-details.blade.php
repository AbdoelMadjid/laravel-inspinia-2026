...
@section('title', 'Seller Details | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                            ...
                            <div class="card card-top-sticky">
                                <div class="card-body pt-0">
                                    <article class="card card-out-of-container border-top-0">
                                        <div class="position-relative card-side-img overflow-hidden rounded-top" style="height: 180px; background-image: url({{ asset('assets/images/seller-profile.jpg') }})">
                                            <div class="p-4 card-img-overlay rounded-start-0 auth-overlay d-flex rounded-top align-items-center justify-content-center"></div>
                                        </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center rounded border-light p-3 bg-light-subtle border">
                                                <div class="d-flex justify-content-start align-items-center gap-3">
                                                    <div class="avatar avatar-xxl">
                                                        <img src="{{ asset('assets/images/sellers/4.png') }}" alt="avatar-2" class="img-fluid img-thumbnail rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="">
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <p class="mb-0 fs-sm">Owner: <span class="fw-semibold">Alex Johnson</span></p>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <p class="mb-0 fs-sm">Business Type: <span class="fw-semibold">E-commerce Electronics</span></p>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <p class="mb-0 fs-sm">Support: <a href="mailto:support@example.com" class="text-primary fw-semibold">support@example.com</a></p>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <p class="mb-0 fs-sm">Website: <a href="https://www.example.com" class="text-primary fw-semibold">www.example.com</a></p>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="card border-0 bg-info bg-opacity-10">
                                                <div class="card-body">
                                                    ...
                                                    <p class="mb-0">
                                                        ...
                                                        <span class="float-end"><b>5k</b></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card border-0 bg-secondary bg-opacity-10">
                                                <div class="card-body">
                                                    ...
                                                    <p class="mb-0">
                                                        ...
                                                        <span class="float-end"><b>750</b></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div data-table data-table-rows-per-page="8" class="card">
                                        <div class="card-header border-light justify-content-between">
                                            ...
                                            <div class="d-flex gap-1">
                                                ...
                                                <a href="{{ route('page', 'apps-ecommerce-product-add') }}" class="btn btn-danger ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Add Product </a>
                                            </div>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 class="mb-0">
                                                                        <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Gaming Laptop Pro</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 class="mb-0">
                                                                        <a data-sort="product" href="{{ route('page', 'apps-ecommerce-product-details') }}" class="link-reset">Vintage Leather Wallet</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/ecommerce-seller-details.js') }}"></script>
@endpush
