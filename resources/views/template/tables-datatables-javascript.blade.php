...
@section('title', 'Javascript Source Datatables | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/datatables-javascript-source.js') }}"></script>
@endpush
