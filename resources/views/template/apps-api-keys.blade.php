...
@section('title', 'API Keys | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="avatar-xl text-bg-light rounded-circle">
                                            <span class="avatar-title">
                                                <i class="ti ti-server-bolt fs-xxl"></i>
                                            </span>
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="avatar-xl text-bg-light rounded-circle">
                                            <span class="avatar-title">
                                                <i class="ti ti-alert-triangle fs-xxl"></i>
                                            </span>
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="avatar-xl text-bg-light rounded-circle">
                                            <span class="avatar-title">
                                                <i class="ti ti-activity fs-xxl"></i>
                                            </span>
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <table class="table table-custom table-centered table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('assets/images/flags/ca.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        CA
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('assets/images/flags/fr.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        FR
                                                    </span>
                                                </td>
                                                <td>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/apps-api-keys.js') }}"></script>
@endpush
