...
@section('title', 'Create Invoice | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    ...
                                                    <div class="border rounded position-relative d-flex text-center align-items-center justify-content-between px-2" style="height: 60px; width: 260px">
                                                        ...
                                                        <img id="preview" src="{{ asset('assets/images/logo-black.png') }}" alt="Company Logo" height="28" />
...
@push('scripts')
    <script src="{{ asset('assets/js/pages/apps-create-invoice.js') }}"></script>
@endpush
