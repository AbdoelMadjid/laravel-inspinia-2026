...
@section('title', 'Apex Area Charts | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                                    ...
                                    <div dir="ltr">
                                        ...
                                        <div class="pt-2 pb-1">
                                            <div class="d-flex justify-content-center align-items-center gap-2">
                                                <img src="{{ asset('assets/images/logo-sm.png') }}" class="avatar-sm rounded" alt="file-image">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/samples/github-data.js') }}"></script>
    <script src="{{ asset('assets/js/samples/irregular-data-series.js') }}"></script>
