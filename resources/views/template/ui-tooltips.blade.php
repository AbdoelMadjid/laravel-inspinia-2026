...
@section('title', 'Tooltips | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2">Documentation and examples for adding custom Bootstrap tooltips with CSS and JavaScript using CSS3 for animations and data-bs-attributes for local title storage.</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <button type="button" class="btn btn-purple" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-purple" data-bs-title="This is a purple tooltip with a vibrant style.">Purple tooltip</button>
                                        </div>
                                    </div>
                                    <!-- end card-body -->
                                </div>
