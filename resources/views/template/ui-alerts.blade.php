...
@section('title', 'Alerts | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template')
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2">Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages.</p>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-dark" role="alert">Dark alert—use for general-purpose messages.</div>

                                        <div class="alert alert-purple mb-0" role="alert">Purple alert—use for general-purpose messages.</div>
                                    </div>
                                    <!-- end card-body -->
                                </div>
                                <!-- end card-->
...
@push('scripts')
    <script src="{{ asset('assets/js/pages/ui-alerts.js') }}"></script>
@endpush
